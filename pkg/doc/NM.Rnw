...
The \texttt{brainNM} data set yearly cases of brain cancer in New Mexico from
...
cl0<-DetectClustersModel(brainst, coordinates(brainst@sp), 
   minDateUser="1988-01-01", maxDateUser="1989-01-01",
   fractpop=.5, alpha=1, typeCluster="ST", R=NULL, numCPUS=2, model0=m0)
@
