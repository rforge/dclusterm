...
clear how to use GLMs to detect clusters of disease, i.e., a group of
...
free, open source \pkg{DClusterm} package for the \proglang{R} statistical
software. This approach involves fitting many different GLMs for which dummy
variables that represent possible clusters are included one at a time. Cluster
detection is based on selecting a number of dummy cluster variables using
...
ny.cl0 <- DetectClustersModel(NY8st,
 ...
 typeCluster = "S", R = NULL, model0 = ny.m0, ClusterSizeContribution = "POP8")
@
...
ny.cl1<-DetectClustersModel(NY8st, 
  ...
  typeCluster = "S", R = NULL, model0 = ny.m1, ClusterSizeContribution = "POP8")
@
